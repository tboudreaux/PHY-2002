...
class Ui_Header(object):
    def setupUi(self, Header):
        ...
        self.stdev = QtGui.QTextEdit(Header)
        self.stdev.setGeometry(QtCore.QRect(420, 190, 104, 21))
        self.stdev.setToolTip(_fromUtf8(""))
        self.stdev.setAutoFillBackground(False)
        self.stdev.setObjectName(_fromUtf8("stdev"))
        self.mean = QtGui.QTextEdit(Header)
        self.mean.setGeometry(QtCore.QRect(310, 190, 104, 21))
        self.mean.setToolTip(_fromUtf8(""))
        ...
        self.label_3.setGeometry(QtCore.QRect(420, 170, 91, 17))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.label_5 = QtGui.QLabel(Header)
        self.label_5.setGeometry(QtCore.QRect(310, 170, 91, 17))
    ...
    def retranslateUi(self, Header):
        ...
        self.label_2.setText(_translate("Header", "Amplitude:", None))
        self.label_3.setText(_translate("Header", "StDev:", None))
        self.label_5.setText(_translate("Header", "Mean:", None))
